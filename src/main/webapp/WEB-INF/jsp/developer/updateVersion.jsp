		...
		<div class="row">
			...
			<div class="col-lg-12 heading">
				...
				<ul class="breadcrumb">
					...
					<li><i class="ec-pencil2"></i>修改版本信息</li>
				</ul>
				<!-- End .breadcrumb -->
			</div>
			<!-- End .page-header -->
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default toggle" id="spr_1">
						<!-- Start .panel -->
						<div class="panel-heading">
							<h2 class="panel-title">修改APP版本信息</h2>
				...
				<textarea id="versionInfo" required="required" name="versionInfo"
						  class="form-control col-md-7 col-xs-12"
						  placeholder="本信息作为软件的详细信息进行软件的介绍">${newAppVersion.versionInfo }</textarea>
									</div>
								</div>
